...
const pattern5 = new RegExp('fo*'); //直前の0回以上の繰り返し。直前のf・oとマッチする文字列をすべて繰り返し検証し表示するため[f]が表示される
const pattern6 = new RegExp('fo+'); //直前の1回以上の繰り返し。直前の文字列[o]も見ているためこの場合はエラーが吐かれる
